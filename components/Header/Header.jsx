...
import { faBars, faEnvelopeOpenText, faPhoneSquare, faXmark } from "@fortawesome/free-solid-svg-icons"
...
export const Header = ()=>{
    ...
    return (
        ...
        >
          ...
          <span
            className="mr-3 underline hover:text-red-500 cursor-pointer"
          >
            Categories
          </span>
          <Link className="mr-3 underline hover:text-red-500" href="/about-us">
            About Us
          </Link>
          ...
          <button onClick={()=>setOpenMNav(true)} type="button" className="rounded sm:hidden">
            <FontAwesomeIcon
              icon={faBars}
              width={30}
              height={30}

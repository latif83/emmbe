...
export const Contact = ()=>{
    return (
        ...
        <motion.div id="getInTouch" initial={{ opacity: 0, y: -100 }}
                ...
                transition={{ duration: 1 }} className="container px-6 md:px-12 mt-20">
                ...
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:mb-12 xl:w-6/12">
                    <div className="align-start flex">
                      ...
                      <div className="ml-6 grow">
                        ...
                        <p className="text-neutral-500">+233 241 970 156</p>
                        <p className="text-neutral-500">+233 277 155 151</p>
                      </div>
                    </div>
                  </div>

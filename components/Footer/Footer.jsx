...
export const Footer = ()=>{
    return (
        <footer>
    <div className="bg-gray-300 py-4 text-gray-800">
      <div className="container px-4 mx-auto">
        <div className="-mx-4 flex flex-wrap justify-between">
          ...
          <div className="px-4 my-4 w-full xl:w-auto">
            <div>
              <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-yellow-400">Company</h2>
            </div>
          ...
          <div className="px-4 my-4 w-full sm:w-auto xl:w-1/3">
            <div>
              <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-yellow-400">Connect With Us</h2>
            </div>
            <div className="flex gap-2">
            <a href="#" className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-yellow-400 hover:border-yellow-400">
            ...
            <a href="#" className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full hover:text-yellow-400 hover:border-yellow-400">
